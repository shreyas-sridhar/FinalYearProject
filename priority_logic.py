...
LEDs = {
    "Signal1": {"Red": 11, "Yellow": 13, "Green": 15, "White": 29},
    "Signal2": {"Red": 31, "Yellow": 33, "Green": 35, "White": 37}
}
...
def rfid_listener_multi():
    ...
    # Instantiate two readers. Adjust device parameters as needed for your hardware.
    reader1 = MFRC522(dev='/dev/spidev0.0')  # Reader 1 (CE0)
    reader2 = MFRC522(dev='/dev/spidev0.1')  # Reader 2 (CE1)
